...
class Container extends React.Component {
    ...
    render() {
        ...
        const { projectList, actionSetting, delProject, addProjectBackend, changeActionProject, changeDevStatus, changeUploadStatus, changePackStatus } = this.props;
        ...
        return (
            <div className="app-container" data-layout-type={layoutType}>
                ...
                <div className="main-content-area">
                    {EN === "resource-management" && <ProjectList data={projectList} delProjectHandler={delProject}  changeDevStatusHandler={changeDevStatus} changeUploadStatusHandler={changeUploadStatus} changePackStatusHandler={changePackStatus} addProjectHandler={addProjectBackend} changeActionProject={changeActionProject} onClickHandler={this.handleActionProjectClick} />}
