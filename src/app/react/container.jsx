...
class Container extends React.Component {
    ...
    render() {
        const { actionMenuSelectedIndex, proxyList, docList, installList, actionProjectSelectedIndex, updateProxyHost, addProxyItem, updateProxyItem, deleteProxyItem } = this.props;
